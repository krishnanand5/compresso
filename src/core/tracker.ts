/**
 * Runtime-agnostic event sink for compresso.
...
export interface TrackEvent {
   ...
   *  tail excluded). Changes turn-over-turn within a session ⇒ compresso-side cache
...
/** Tracker that drops everything. Used when COMPRESSO_TRACK=0. */
