...
![chart: characters a frontier context window holds, 2018–2026 — vendor text series including Grok 4.5; orange measured overlay is Fable 5 [1m] + pxpipe ~18M (4.6×)](assets/context-window-chars.png)
...
- **Client-dependent.** Savings track uncached bulk the client still
  ...
  splits: [CACHING_AND_SAVINGS.md](CACHING_AND_SAVINGS.md).
...
[the legibility audit](LEGIBILITY-AUDIT-2026-07-01.md) quantifies
